...
$string['gdpr'] = 'GDPR';
$string['gdpr_help'] = 'GDPR related settings';
$string['policyname'] = 'Policy name';
$string['policyname_desc'] = 'The name of the policy that is shown to the user regarding GDPR.';
$string['filters'] = 'Filter logs';
$string['logguests'] = 'Log guest actions';
$string['logstudentsonly'] = 'Log student actions only';
$string['logstudentsonly_desc'] = 'If this is enabled, the plugin will only log actions from students.';
$string['activateusernamehashing'] = 'Activate username hashing';
$string['activateusernamehashing_desc'] = 'If this is enabled, the plugin will hash usernames before sending them to the LRS.';
$string['customfield_shortname'] = 'Course custom field shortname';
$string['customfield_shortname_desc'] = 'The shortname of the custom field that is used to identify if logging is enabled for a course.';
