...
$string['gdpr'] = 'GDPR';
$string['gdpr_help'] = 'GDPR-relaterade inställningar';
$string['policyname'] = 'Policyns namn';
$string['policyname_desc'] = 'Namnet på den policy som visas för användaren avseende GDPR.';
$string['filters'] = 'Filtrera loggar';
$string['logguests'] = 'Logga gästers handlingar';
$string['logstudentsonly'] = 'Logga endast studentåtgärder';
$string['logstudentsonly_desc'] = 'Om detta är aktiverat kommer plugin-programmet endast att logga åtgärder från studenter.';
$string['activateusernamehashing'] = 'Aktivera hashing av användarnamn';
$string['activateusernamehashing_desc'] = 'Om detta är aktiverat kommer insticksprogrammet att hasha användarnamn innan de skickas till LRS.';
$string['customfield_shortname'] = 'Kortnamn för kursens anpassade fält';
$string['customfield_shortname_desc'] = 'Kortnamnet på det anpassade fält som används för att identifiera om loggning är aktiverad för en kurs.';
