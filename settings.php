...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_heading(
        'gdpr',
        get_string('gdpr', 'logstore_xapi'),
        get_string('gdpr_help', 'logstore_xapi')
    ));

    $settings->add(new admin_setting_configtext(
        'logstore_xapi/policyname',
        get_string('policyname', 'logstore_xapi'),
        get_string('policyname_desc', 'logstore_xapi'),
        '',
        PARAM_TEXT
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'logstore_xapi/logstudentsonly',
        get_string('logstudentsonly', 'logstore_xapi'),
        get_string('logstudentsonly_desc', 'logstore_xapi'),
        '0'
    ));
    ...
    $settings->add(new admin_setting_configtext(
        ...
        get_string('customfield_shortname_desc', 'logstore_xapi'),
        '',
        PARAM_TEXT
    ));
